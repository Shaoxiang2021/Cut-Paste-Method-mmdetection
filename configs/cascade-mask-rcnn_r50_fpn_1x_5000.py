...
work_dir = '../results/cascade-mask-rcnn_5_cpuft_5000_1'
...
param_scheduler = [dict(type='LinearLR', start_factor=1e-07, by_epoch=False, begin=0, end=500), dict(type='CosineAnnealingLR', T_max=12000, by_epoch=False, begin=500, end=12500)]
